...
#-----------------------------
#
#This R script loads the CAOS-R package and executes the CAOS-Classifier program
#[function: caos_classifier()]. The classifier will find the closest match between
#unidentified query data and barcoder generated reference data.This R script can 
#automatically locate it's current location. 
#It is mandatory that the input data is stored in a folder labelled
#"input_classifier". The "input_classifier" folder with the user data must be located
#in the same directory as this script (CAOS-Classifier). Examples for the correct
